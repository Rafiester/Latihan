...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        when (lemonadeState) {
            ...
            //Jika lemon diminum akan menampilkan gelas kosong dan direstart
            DRINK -> {
                lemonadeState = RESTART
                lemonSize = -1
            }
            //Mengulangi proses dari awal pemetikan pohon
            RESTART -> lemonadeState = SELECT
        }
        //Memanggil setViewElement untuk menampilkan gambar
        setViewElements()
    }
